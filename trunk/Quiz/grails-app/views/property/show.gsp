            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="property.value.label" default="Value" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: propertyInstance, field: "value")}</td>
