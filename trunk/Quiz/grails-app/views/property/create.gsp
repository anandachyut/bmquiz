                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="value"><g:message code="property.value.label" default="Value" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: propertyInstance, field: 'value', 'errors')}">
                                    <g:textField name="value" value="${propertyInstance?.value}" />
                                </td>
                            </tr>
